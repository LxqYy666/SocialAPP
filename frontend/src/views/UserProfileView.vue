		...
		<el-card class="user-profile-card" shadow="never">
			...
			<div class="profile-nav-wrap">
				<el-menu
					...
					@select="handleSelect"
				>
					<el-menu-item index="user-profile-info">资料</el-menu-item>
					<el-menu-item index="user-profile-posts">帖子</el-menu-item>
				</el-menu>
			</div>
...
function handleSelect(menuName) {
	router.push({ name: menuName, params: { id: route.params.id } })
}
